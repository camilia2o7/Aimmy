        ...
        private void UpdateOverlay(DetectedPlayerWindow DetectedPlayerOverlay)
        {
            ...
            Application.Current.Dispatcher.Invoke(() =>
            {
                ...
                if (showTracers)
                {
                    ...
                    string align = Dictionary.dropdownState.TryGetValue("Align Tracers", out var val) ? val : "Default";
                    ...
                    DetectedPlayerOverlay.DetectedTracers.X1 = startX;
                    DetectedPlayerOverlay.DetectedTracers.Y1 = startY;
